...
public class LoginServiceImpl implements LoginService {
    ...
    private void generateJWT(LoginUserDTO result) {
        String jwt = JwtUtil.sign(result, getExpireTime());
        result.setJwt(jwt);
    }
    ...
    private void saveUserInfoToRedis(LoginUserDTO result) {
        ...
        redisService.setCacheObject(RedisConstants.USER_INFO_KEY + result.getUserId(), userString, getExpireTime(), TimeUnit.SECONDS);
